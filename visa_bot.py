 ...
 "cells": [
  {
   ...
   "source": [
    ...
    "\n",
    "API_TOKEN = '8334167570:AAHAEEZUrZtAEheT50ZdaJe1QoXw_IlLS0g'\n",
    "\n",
    "apihelper.proxy = {\n",
    "    'https': 'socks5h://127.0.0.1:52461' #  SOCKS proxy is running on localhost port 52461. \n",
    "}\n",
    "\n",
    "\n",
    "# create a bot, which is an abject from telebot\n",
    "\n",
    "bot = telebot.TeleBot(token = API_TOKEN) # by this code, I have an object refering to my bot in telegram\n",
    "\n",
    "@bot.message_handler(commands = ['start']) # next func will be resposible for any command we send (which is 'start' here)\n",
    "def welcome(message):\n",
    ...
    "\n",
    "bot.polling() # by this commend my bot constantly listen for any inputs recived from the users to process and respond"
   ]
  },
  {
   "cell_type": "code",
